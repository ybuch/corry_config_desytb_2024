...
# Only intentended for testing, no data duplication
...
def process_rows(data, trigger_number, timestamp_first, trigger_extension):
    ...
    processed_data = np.empty((output_count, 5), dtype=np.int64)
    ...
    return processed_data, trigger_number, timestamp_first, trigger_extension
